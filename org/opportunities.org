...
** DONE <2016-03-28 Mon 08:17> OPPORTUNITY: SQL Server Database Administrator
...
** DONE [#A] <2016-04-04 Mon 08:17> OPPORTUNITY: SQL Server Database Administrator
SQL Server Database Administrator
About the Job
...
I'm replying to your ad reference job reference code 19850 for a SQL Server Database Administrator

You will find that my background includes for your essential requirements: 
    => 4+​ years of SQL Server DBA experience​ for supporting backend of Futureproof Advertising system.
    => Administrated SQL Server 2005 environment, but familiar with 2008, 2012 and 2014 
    => Sizing, capacity planning, back-up and recovery in mission critical db requirements for adverting/finance system for 150 community newspapers.
    => Have a strong grasp of SQL Server Security Fundamentals re: Authentication and Role based security.
    => Know-how in correlating SQL Profiler with data collection techniques using Performance Monitor (importing log data etc...). Subsequently modifying configuration for optimum performance (re-develop and modify queries, indexes, settings and recommend hardware changes).
    => Expertise in using SSIS for SQL Server workflow automation as well as the fundamental other automation of workflow processes in SQL Server as stored procedures, triggers, functions (built-in and user defined) and transactions analysis (especially for modifying stored procedures and resolving issues).​
    => Accustomed to working long hours and off shift schedules (nights and weekends).​
    => Strong T-SQL skills.​=> Can provide samples of large T-SQL complex stored procedures I have written.

For your preferred requirements:
    =>​ Understanding of indices and how it relates to aggregate data information (statistical data).
    =>​ Have programmed in multiple languages like Ruby, Python, PHP and  Visual Basic
    =>​ Understanding and experience with Windows Failover Clustering for redundancy and high availability and how this works with log shipping.
    => Experience in working in mission critical environment for 150 community newspapers which includes the MetroWest Daily News and Patriot Ledger.
    => Agile: Familiar with scrum process and collaboration using Git and Bitbucket
    => Profiency and  familiar with scripting languages as used in system administration which includes the Microsoft family like  Powershell, VBscript and CMD, but in addition know Python and Ruby and how to interface with COM.
    => Have configured Wamp and Lamp servers. (Windows Apache MySQL to PHP and Linux Apache MySQL to PHP)
    => Can lead a team of tech professionals.
    ​=> Can write and present information very well.​
    => Enjoy working with a team to accomplish results.

   

If you are seeking a seasoned IT profession that meets many of your requirements plus many additional areas of expertise in this rapidly changing environment. Please contact me for an interview.
...
Date: <2016-04-01 Fri 08:17> 
Position: Database Administrator
Payrate: $79560
Employer name/address/phone/URL: http://jobview.monster.com/SQL-Server-Database-Administrator-Job-WESTON-MA-US-164960359.aspx?mescoid=1500130001001&jobPosition=23&ac=subscribe
Person Contacted: Anonymouse
HOW CONTACTED - Web, phone, mail, job fair, networking, etc.: Web
Results: Finished application and uploaded resume and coverletter. .


** DONE <2016-04-04 Mon 16:31> OPPORTUNITY: Part-Time Autozoner 
Date: <2016-04-04 Mon 16:31> 
Position: Part-Time Autozoner 
Payrate: $10.00/hr
Employer name/address/phone/URL: https://ehire.autozoneinc.com/psc/EHIRE/EMPLOYEE/HRMS/c/HRS_HRAM.HRS_CE.GBL?Page=HRS_CE_HM_POST&Action=U&HRS_PERSON_ID=35963687
Person Contacted: Anonymouse
HOW CONTACTED - Web, phone, mail, job fair, networking, etc.: Web
Results: Had submitted web application over the internet earlier tried to see if it was possible to apply at another store and it is not possible.

** DONE [#C] <2016-04-05 Tue 07:37> OPPORTUNITY: Senior Systems Administrator

Job description

St. Mary's Bank is looking to fill a full-time Senior Systems Administrator.  This position is responsible for the following outcomes:

    Performs systems software installation, upgrades, configuration, monitoring, and maintenance.
    Performs technical research and implementation within a project life-cycle to transition projects from Business Analyst staff to production staff.
    Provides application and database administration, support, capacity planning, and performance tuning.
    Provides application and system configuration documentation.

Desired Skills and Experience

Qualifications:

    Associates Degree in Computer Science, Business, or related field.  Work experience may be considered a suitable substiture for formal education.
    Four to five years of server based software application installation and support.
    Four to five years of experience with Windows Server Operating Systems, MS SQL Server, MS Access, LINUX, and Oracle.
    Demonstrated ability to meet deadlines, and able to identify and solve problems with a strong attention to detail.
    Project experience as a member implementing complex technologies.
...
I'm replying to your job posted on LinkedIn for a Sr. Systems Administrator

You will find that my background includes for you required qualifications: 
    => 10 years of System Administration experience which includes 4 years of SQL Server DBA experience​ for supporting backend of Futureproof Advertising system.
    => 5+ years working with server/cloud based systems at an administrative level which includes installation, implementation and support.
    => 5+ years working with Windows Server Operating Systems, MS SQL Server, MS Access and LINUX  
    => Project sizing, capacity planning, back-up and recovery for mission critical db requirements for advertising/finance system for 150 community newspapers.
    => Accustomed to working long hours and off shift schedules (nights and weekends).​
    => Strong T-SQL skills.​=> Can provide samples of large T-SQL complex stored procedures I have written. (This is a SQL Server technology)
...
*** YAML
Date: <2016-04-05 Tue 07:37> 
Position:  Senior Systems Administrator
Payrate: $80K/Yr
Employer name/address/phone/URL: https://www.linkedin.com/jobs2/view/118716732?trk=jobs_home_saved_jobs
Person Contacted: Pamela Roy
HOW CONTACTED - Web, phone, mail, job fair, networking, etc.: Web
Results: This is St. Mary's bank not St. Mary's CU in Marlboro. But will apply anyway as it says Greater Boston Area. Reached a snag was only able to send resume via LinkedIn (not sure where it went?). Would need to subscribe to InMail to send a resume. $30/mo ??!!

** TODO [#A] <2016-04-05 Tue 09:50> OPPORTUNITY:  Real Estate Sales Agent Position

POSITION: Real Estate Agent
Hello Ray,

My name is Allen Quinn, and I am a Regional Manager with Berkshire Hathaway HomeServices N.E. Prime Properties in Massachusetts. I came across your resume and thought you may be interested in developing a career selling residential real estate.

I am looking to add someone to my team that is business minded, entrepreneurial, motivated, and dedicated to building their book of business. My office offers an extensive training program with one of the most well-known real estate companies in the area. This position offers unlimited income potential in a commission based environment and the flexibility of managing your own clients and schedule./p>

If you would like to have a chance to sit down with me to discuss this opportunity further, simply Click Here OR copy and paste this url: http://www.proactess.com/evite/Berkshire-Hathaway-Home-Services-New-Eng/737/D3kYIX0jlGqf13ru+ynupOucV1wyQjChZB3olmtIMic^ to apply today by submitting your updated resume.
...
54 Main Street, Suite 204
Maynard, MA 01754 
allen.quinn@proactmail.com


*** YAML

Date: <2016-04-05 Tue 09:50> 
Position: Real Estate Sales Agent Position
Payrate: $40k/yr 
Employer name/address/phone/URL: Berkshire Hathaway HomeServices N.E. Prime Properties
Person Contacted: Allen Quinn
HOW CONTACTED - Web, phone, mail, job fair, networking, etc.: Web/email
Results:



** TODO [#A] <2016-04-05 Tue 10:47> OPPORTUNITY: Email from Staffing Manager at Winter and Wyman

Hi Ray,


Hope you are well, I would like to talk to you about your profile and few opportunities that i am recruiting for. please let me know a good time to connect...thanks!


Inshia Lakhia

Staffing Manager | Technology Contract Staffing

WinterWyman Contract Staffing

880 Winter Street | Suite 200 | Waltham, MA 02451

Boston 781.530.3177 | New York 212.589.5362

*** YAML

Date: <2016-04-05 Tue 10:47> 
Position: IT related
Payrate: $80k/yr
Employer name/address/phone/URL: winterwyman.com
Person Contacted: Inshia Lakhia
HOW CONTACTED - Web, phone, mail, job fair, networking, etc.: Web/email
Results:
